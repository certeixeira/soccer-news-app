package com.certeixeira.soccernews.data;

import androidx.room.Room;

import com.certeixeira.soccernews.data.local.AppDatabase;
import com.certeixeira.soccernews.App;
import com.certeixeira.soccernews.data.remote.SoccerNewsApi;
...
public class SoccerNewsRepository {
    ...
    //region Constantes
    private static final String REMOTE_API_URL = "https://certeixeira.github.io/soccer-news-api/";
